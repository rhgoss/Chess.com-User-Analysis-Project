...
'''
#For this section of the project, a majority of this code is borrowed from the shedloadofcode.com article that inspired
this project. I did need to spend time updating certain aspects of the code for a more current selenium version and
tailoring it to my account specifically, but the logic used remained the same. 
